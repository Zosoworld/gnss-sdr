...
#ifndef GNSS_SDR_GPS_L1_CA_DLL_PLL_FLL_TRACKING_CC_H
#define GNSS_SDR_GPS_L1_CA_DLL_PLL_FLL_TRACKING_CC_H
...
typedef boost::shared_ptr<Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc>
        gps_l1_ca_dll_pll_fll_tracking_cc_sptr;

gps_l1_ca_dll_pll_fll_tracking_cc_sptr
gps_l1_ca_dll_pll_fll_make_tracking_cc(long if_freq,
                                   long fs_in, unsigned
                                   int vector_length,
                                   bool dump,
 ...
 */
class Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc: public gr::block
{
public:
    ~Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc();
...
private:
    friend gps_l1_ca_dll_pll_fll_tracking_cc_sptr
    gps_l1_ca_dll_pll_fll_make_tracking_cc(long if_freq,
            long fs_in, unsigned
            int vector_length,
            bool dump,
...
#endif //GNSS_SDR_GPS_L1_CA_DLL_PLL_FLL_TRACKING_CC_H

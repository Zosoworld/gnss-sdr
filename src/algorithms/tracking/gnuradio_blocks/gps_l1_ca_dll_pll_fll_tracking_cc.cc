...
#include "gps_l1_ca_dll_pll_fll_tracking_cc.h"
#include <cmath>
#include <iostream>
#include <memory>
#include <sstream>
...
gps_l1_ca_dll_pll_fll_tracking_cc_sptr
gps_l1_ca_dll_pll_fll_make_tracking_cc(
        long if_freq,
        long fs_in,
...
void Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc::forecast (int noutput_items,
...
Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc::Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc(
        long if_freq,
        long fs_in,
        unsigned int vector_length,
        bool dump,
...
void Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc::start_tracking()
{
...
int Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc::save_matfile()
{
    // READ DUMP FILE
    ...
    if(d_dump)
        {
            ...
            Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc::save_matfile();
            if(d_channel == 0)
                {
...
int Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc::general_work (int noutput_items __attribute__((unused)), gr_vector_int &ninput_items __attribute__((unused)),
...
void Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc::set_channel(unsigned int channel)
{
    d_channel = channel;
...
void Gps_L1_Ca_Dll_Pll_Fll_Tracking_cc::set_gnss_synchro(Gnss_Synchro* p_gnss_synchro)
{
